...
export default function Footer() {
    ...
    return <>
        <footer className="bg-black">
            ...
            <h2 className="text-white pl-4 pb-8 flex justify-center items-center">Vasen medicina Estética y Bienestar <img src="/svgs/cr.png" alt="" className="w-3 h-3 mr-2 ml-2"/> 2025 Todos los derechos reservados</h2>
